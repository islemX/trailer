...
function AddMovie({movieName, setMovieName}) {
  ...
  return (
    <>
      <Button variant="outline-dark" onClick={handleShow} style={{marginLeft:'100px', width:'450px' ,border:"azure solid" }}>
        Add New Movie 
      </Button>
      <Modal
        show={show}
      ...
      >
        ...
        <FormControl    aria-label="Default"
                 aria-describedby="inputGroup-sizing-default" onChange={(e)=> setNewTrailer(e.target.value) } />
             </InputGroup>
